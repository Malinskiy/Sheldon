...
import com.malinskiy.sheldon2.IAdapterProvider;
...
import com.malinskiy.sheldon2.codegen.model.Preference;
...
public class PreferencesProcessor extends AbstractProcessor {
    ...
    private final Map<String, Preference> preferenceInterfaces = new LinkedHashMap<>();
    private final Map<TypeMirror, Element> adapters = new LinkedHashMap<>();
